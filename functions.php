...
function humescores_fonts_url() {
	...
	if ( 'off' !== $source_sans_pro ) {
		$font_families[] = 'Source Sans Pro: 200,300,400,400i,700,900';
	}

	if ( 'off' !== $pt_serif ) {
		$font_families[] = 'PT Serif: 400,400i,700,900';
	}
...
function humescores_scripts() {
	...
	wp_enqueue_style( 'humescores-googleFonts', humescores_fonts_url() );
